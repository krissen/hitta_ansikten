...
- [ ] **Städa staging efter sign-off.** ~91 GB `benchmark_staging/` kan tas bort när slutrapporten är accepterad; körningen är reproducerbar från backup. B6+ är nu klart, så städningen väntar enbart på ägarens avrop.
