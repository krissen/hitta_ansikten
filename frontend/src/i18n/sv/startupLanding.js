...
module.exports = {
  title: 'Kom igång',
  subtitle:
    'Ansikten tar dig genom hela flödet — från minneskort till färdigt gallrade bilder.',
  barHint:
    'Välj ett steg i arbetsflödesraden överst, eller dra in filer för att börja.',
