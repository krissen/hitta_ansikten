...
module.exports = {
  ...
  dialogs: {
    ...
    reset: {
      ...
      message:
        'Återställ alla temaändringar till standardvärdena? Dina osparade justeringar av färger och storlekar tas bort. Sparade förval påverkas inte.',
      confirm: 'Återställ',
    },
  },
  toasts: {
    importError:
      'Kunde inte importera förval. Kontrollera att filen är en giltig temaexport (JSON).',
  },
  buttons: {
    export: 'Exportera',
    import: 'Importera',
