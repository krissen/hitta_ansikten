...
module.exports = {
  ...
  tooltips: {
    ...
    notADuplicate:
      'Detta är olika personer som liknar varandra (t.ex. tvillingar); föreslå aldrig att de slås samman',
    allowSuggestAgain: 'Tillåt att detta par föreslås igen',
    redundantThreshold:
      '0 = endast exakta dubbletter; högre värden tar även bort nästan identiska kodningar',
  },
  misc: {
  ...
  toasts: {
    ...
    foundDuplicates: {
      ...
      other:
        'Hittade {count} dubblettkandidater bland {people} personer (≤ {threshold})',
    },
    ...
    foundRedundant: {
      ...
      other:
        '{count} överflödiga kodningar bland {people} {peopleWord} (≤ {threshold})',
    },
    redundancyScanFailed:
      'Kunde inte söka efter överflödiga kodningar: {error}',
  ...
  dialogs: {
    ...
    mergeConfirm:
      'Slå samman ”{source1}” och ”{source2}” till ”{target}”{backendDesc}?',
    mergePairConfirm: 'Slå samman ”{drop}” till ”{keep}”?',
    dedupConfirm: {
      one: 'Ta bort {count} överflödig kodning från {who}? Detta kan inte ångras.',
      other:
        'Ta bort {count} överflödiga kodningar från {who}? Detta kan inte ångras.',
    },
    deleteConfirm:
      'Radera ”{name}”? Detta tar bort alla deras kodningar permanent.',
    moveToIgnoreConfirm: 'Flytta ”{name}” till ignorerade{backendDesc}?',
    moveFromIgnoreConfirm:
      'Flytta {count} kodningar från ignorerade till ”{target}”{backendDesc}?',
    undoConfirm: 'Ångra bearbetning för filer som matchar ”{pattern}”?',
    recentFilesTitle: 'Senaste bearbetade filer',
    purgeConfirm:
      'Ta bort de senaste {count} kodningarna från ”{name}”{backendDesc}? Detta kan inte ångras.',
  },
};
