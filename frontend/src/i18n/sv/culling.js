...
module.exports = {
  ...
  stats: {
    ...
    deltaTitle:
      'Avvikelse från baslinjen — medianen eller medelvärdet av bildantalet för de inkluderade spelarna. Positivt = fler bilder än baslinjen, negativt = färre.',
    excludedLabels: {
      tranare: 'Tränare',
      grupp: 'Gruppbilder',
      publik: 'Publik',
  ...
  errors: {
    ...
    unsupportedPlatform: 'Öppna i extern editor stöds bara på macOS',
    editorFailed:
      'Kunde inte öppna i "{editor}". Kontrollera appnamnet under Inställningar → Filer{detail}',
    fileNotFound: 'Filen hittades inte. Den kan ha flyttats eller tagits bort.',
    fileUnreadable:
      'Filen kunde inte läsas. Kontrollera att den finns och inte används av ett annat program.',
