...
module.exports = {
  ...
  tooltips: {
    ...
    detectedCount: {
      one: '{count} ansikte hittat',
      other: '{count} ansikten hittade',
    },
    notLoaded: 'Ej inläst',
  ...
  toasts: {
    ...
    preprocessingPaused: {
      one: 'Förbehandling pausad ({count} fil redo)',
      other: 'Förbehandling pausad ({count} filer redo)',
    },
    ...
    trashFailed:
      'Kunde inte flytta {fileName} till papperskorgen. Försök igen.',
    ...
    preprocessingComplete: {
      one: 'Förbehandling klar ({count} fil cachad)',
      other: 'Förbehandling klar ({count} filer cachade)',
    },
    ...
    allProcessed:
      'Alla filer är redan behandlade. Aktivera fixläge för att behandla om.',
    noSupportedSkipped:
      'Inga bildfiler som stöds (hoppade över {count} filer som inte är bilder)',
    addedFiles: {
    ...
    fileAlreadyProcessed:
      '{fileName} är redan behandlad. Aktivera fixläge eller klicka på 🔄 för att behandla om.',
  ...
  dialogs: {
    renameConfirm: {
      ...
      other:
        'Byt namn på {count} filer{selection}?\n\nDetta byter namn på filer utifrån hittade ansikten.\nSe Inställningar för namnformat.',
    },
